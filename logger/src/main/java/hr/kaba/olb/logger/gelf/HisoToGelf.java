...
public class HisoToGelf {
    ...
    public enum Mapping {
        ...
        AMOUNT(Arrays.asList(ProductIndicator.TRANSACTION_PRODUCTS), "amount", message -> message.getFields().get(PrimaryBitmapField.P4)),
        ...
        static List<Mapping> valuesFor(ProductIndicator productIndicator) {
            return Arrays.asList(Mapping.values())
                         .stream()
