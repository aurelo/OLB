...
class HisoHeaderTest {
    ...
    void correctlyEncodeLoginRequestHeader() {
        ...
        String expectedPayload = String.format("%2s", (char) 68);
    ...
    void correctlyEncodeAtmDepositAdvice() {
        ...
        String expectedPayload = String.format("%2s", (char) 318);
...
//        String expectedPayload = String.format("%s%s", (char) 1, (char) 10);
        String expectedPayload = String.format("%2s", (char) (266 & 0xFFFF));
